...
import { GoOrganization } from "react-icons/go";
 import "../../NGO/Program/ProgramDetail.css";
...
const Programadminform = () => {
  ...
  useEffect(() => {
    const fetchProgramDetails = async () => {
      try {
        const data = await getProgramById(programId); // Fetch program by ID
  ...
  const handleViewDonations = () => {
    navigate(`/admin/ngo/${program.ngoId}/program/${program.programId}/donations`);
  };
