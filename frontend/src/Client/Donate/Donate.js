...
const Donate = () => {
  ...
  const handleSuccess = async (details) => {
    try {
      ...
      const donationData = {
        donorName: donationResponse.data.donorName,
        donorEmail: donationResponse.data.donorEmail,
        donationAmount: amount,
        donationDate: new Date().toLocaleDateString(),
        paymentMethod: "PayPal",
        logoUrl: "https://give-aid.org/logo.png",
      };

      navigate("/thank-you", { state: { donationData } });
        ...
        <div className="target-progress">
          ...
          <div className="progress-container">
            <div
              ...
              style={{ width: `${program.percentageAchieved}%` }}
            ></div>
          </div>
