                ...
                <div className='list-ims'>
                    <div className='list-asset'>
                        <div className='list-img'>
                            <picture>
                                <img src='https://www.charitynavigator.org/adobe/dynamicmedia/deliver/dm-aid--658c98f1-7db9-4874-bb4f-67dc6b93cd48/atom_illo_GivingCircle.svg.webp?preferwebp=true&width=760' alt='Img'/>
                            </picture>
                        </div>
                    </div>
